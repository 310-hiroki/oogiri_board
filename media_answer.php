...
if (isset($_POST["answer"])) {
  ...
  $sql = "INSERT INTO media_answer (kaitou, odai_id, account_id, kaitou_time, kaitou_point) VALUES (:kaitou, :odai_id, :account_id, now(), 0);";
...
<head>
  ...
  <body>
    <h1>大喜利掲示板</h1>
      ...
      <br>
      <a href="http://co-994.it.99sv-coco.com/media.php?id=<?php  echo $row['id'];  ?>">お題に戻る</a>
  </body>
</html>
